...
def run_tests() -> List[TestResult]:
    ...
    success, output = run_command("python csv_importer.py --csv test_data_types.csv --table test_auto --create-table --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_data_types.csv --columns-file test_columns.txt --table test_columns --create-table --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_initial.csv --table test_upsert --create-table --primary-key id --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_updates.csv --table test_upsert --primary-key id --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_complex_types.csv --table test_types --create-table --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_bad_data.csv --table test_errors --create-table --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_additional.csv --table test_types --if-exists append --force")
    results.append(TestResult(
    ...
    success2, output = run_command("python csv_importer.py --csv test_books_data.csv --table test_integration --primary-key isbn --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_unicode.csv --table test_unicode --create-table --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_nulls.csv --table test_nulls --create-table --force")
    results.append(TestResult(
    ...
    success, output = run_command("python csv_importer.py --csv test_reserved_words.csv --table test_reserved --create-table --force")
    results.append(TestResult(
